...
public static class DTPrefs
{
    ...
    public static void SetInputProfile(string key, InputProfile profile)
    {
        foreach (var keyValuePair in profile.keys)
        {
            SetKey(key + keyValuePair.Key, keyValuePair.Value);
        }
    }

    public static InputProfile GetInputProfile(string key)
    {
